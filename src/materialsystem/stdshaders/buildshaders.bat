...
if not exist "%sourcesdk%\bin\orangebox\bin\shadercompile.exe" goto NoShaderCompile
...
:NoShaderCompile
echo -
rem echo - ERROR: shadercompile.exe doesn't exist in %SDKBINDIR%
echo -
goto end
...
echo "%sourcesdk%\bin\orangebox\bin\shadercompile.exe >> filestocopy.txt
echo "%sourcesdk%\bin\orangebox\bin\shadercompile.exe\shadercompile_dll.dll >> filestocopy.txt
echo "%sourcesdk%\bin\orangebox\bin\shadercompile.exe\vstdlib.dll >> filestocopy.txt
echo "%sourcesdk%\bin\orangebox\bin\shadercompile.exe\tier0.dll >> filestocopy.txt
