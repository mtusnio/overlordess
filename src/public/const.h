...
// Max size of the overlord's area name
#define MAX_AREA_NAME_SIZE 40
#define NUM_OF_CLASSES 4

// Overlord-specific define, defined only when you need playtest commands
#define OVER_PLAYTEST 1

// Overlord-specific define, Overlord debug
//#define OVER_DEBUG 0

// Max Overlord camera menu buttons
#define MAX_BUTTONS 9
#define DESC_LENGTH 512
#define BUTT_LENGTH 40

// A hack, defines whether we should mount the HL2MP, 
// may help in overcoming that VAC issue
#define OVER_MOUNT_HL2MP 0

// Define playtest if isn't defined and we are in OVER_DEBUG or DEBUG
#ifndef OVER_PLAYTEST
#ifdef (OVER_DEBUG || DEBUG)
#define OVER_PLAYTEST 1
#endif // OVER_DEBUG || DEBUG
#endif // OVER_PLAYTEST
