...
BEGIN_DATADESC( CFuncBrush )
	...
	DEFINE_INPUTFUNC( FIELD_VOID, "SetSolid", InputSetSolid),
	DEFINE_INPUTFUNC( FIELD_VOID, "SetNotSolid", InputSetNotSolid),
...
void CFuncBrush::InputSetSolid( inputdata_t &inputdata )
{
	if ( m_iSolidity != BRUSHSOLID_NEVER )
	{
...
void CFuncBrush::InputSetNotSolid( inputdata_t &inputdata )
{
