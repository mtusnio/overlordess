...
public:
	...
	virtual int GetCurrentTopSpeed() const { return !IsSprinting() ? HL2_NORM_SPEED : HL2_SPRINT_SPEED; };
...
private:
	...
	CNetworkVar( bool,	m_bSprintEnabled );		// Used to disable sprint temporarily
