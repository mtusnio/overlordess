...
ConVar	fraglimit( "mp_fraglimit","0", FCVAR_NOTIFY | FCVAR_DEVELOPMENTONLY);
ConVar	falldamage( "mp_falldamage","2", FCVAR_NOTIFY, "0 for constant, 1 for progressive, 2 for percental" );
