...
public:
	...
	virtual bool CanBePickedUpByPhyscannon( void );
...
private:
	// Helper method for the client side physics stuff
	void CheckForConstrained();
...
protected:
	CNetworkVar( bool, m_bConstrained)
	CNetworkVar( bool, m_bCanBuildOn);
