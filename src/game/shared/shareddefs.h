...
#define HIDEHUD_CAMERA				( 1<<12 )   // Hide hud that the overlord shouldn't see while in the camera view
#define HIDEHUD_OVERLORD			( 1<<13 )	// Only Overlordess can see it
#define HIDEHUD_REBEL				( 1<<14 )	// Only rebels can see it
#define HIDEHUD_OVBETA				( 1<<15 )	// Hide vanilla HUD entirely, use only OVhud.

#define HIDEHUD_BITCOUNT			16
