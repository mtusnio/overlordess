...
#define MAX_MODEL_INDEX_BITS	10 
	...
	BEGIN_RECV_TABLE_NOBASE( CEffectData, DT_EffectData )
		...
		RecvPropBool(RECVINFO(m_bOverlord) ),
	END_RECV_TABLE()
	...
	BEGIN_SEND_TABLE_NOBASE( CEffectData, DT_EffectData )
		...
		SendPropFloat(SENDINFO_NOCHECK(m_flScale) ),
		SendPropFloat(SENDINFO_NOCHECK(m_flLifeTime) ),
		SendPropBool(SENDINFO_NOCHECK(m_bOverlord) ),
