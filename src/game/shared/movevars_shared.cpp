...
ConVar	sv_noclipspeed	( "sv_noclipspeed", "2", FCVAR_ARCHIVE | FCVAR_NOTIFY | FCVAR_REPLICATED);
ConVar	sv_specaccelerate( "sv_specaccelerate", "8", FCVAR_NOTIFY | FCVAR_ARCHIVE | FCVAR_REPLICATED);
...
ConVar	sv_maxspeed		( "sv_maxspeed", "1500", FCVAR_NOTIFY | FCVAR_REPLICATED | FCVAR_DEVELOPMENTONLY);
