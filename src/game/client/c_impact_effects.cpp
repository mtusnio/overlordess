...
void FX_CacheMaterialHandles( void )
{
	...
	// Precache particles too
	PrecacheParticleSystem("ConcreteImpact");
	PrecacheParticleSystem("GlassImpact");
	PrecacheParticleSystem("WoodImpact");
	PrecacheParticleSystem("TileImpact");
}
