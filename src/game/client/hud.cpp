...
bool CHud::IsHidden( int iHudFlags )
{
	...
	if ( ( iHudFlags & HIDEHUD_CAMERA ) && ( iHideHud & HIDEHUD_CAMERA ) )
		return true;

	if ( ( iHudFlags & HIDEHUD_OVERLORD ) && ( iHideHud & HIDEHUD_OVERLORD ) )
		return true;

	if( ( iHudFlags & HIDEHUD_REBEL ) && ( iHideHud & HIDEHUD_REBEL ) )
		return true;
