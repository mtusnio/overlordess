...
void CBaseViewport::CreateDefaultPanels( void )
{
	...
	AddNewPanel( CreatePanelByName( PANEL_POWERUPPANEL), "PANEL_POWERUPPANEL" );
	//AddNewPanel( CreatePanelByName( PANEL_CAMERAMENU ), "PANEL_CAMERAMENU");
	// AddNewPanel( CreatePanelByName( PANEL_TEAM ), "PANEL_TEAM" );
	AddNewPanel( CreatePanelByName( PANEL_CLASS ), "PANEL_CLASS" );
	AddNewPanel( CreatePanelByName( PANEL_OVCLASS ), "PANEL_OVCLASS" );
	AddNewPanel( CreatePanelByName( PANEL_SELECTION ), "PANEL_SELECTION" );
	AddNewPanel( CreatePanelByName( PANEL_TRAPMENU ), "PANEL_TRAPMENU" );
	AddNewPanel( CreatePanelByName( PANEL_TRAPSTATUS ), "PANEL_TRAPSTATUS" );
	AddNewPanel( CreatePanelByName( PANEL_TRAPMANAGER ), "PANEL_TRAPMANAGER" );
	AddNewPanel( CreatePanelByName( PANEL_POPUP ), "PANEL_POPUP" );
	AddNewPanel( CreatePanelByName( PANEL_PROGRESSBAR ), "PANEL_PROGRESSBAR" );
	AddNewPanel( CreatePanelByName( PANEL_STATICTRAPPANEL ), "PANEL_STATICTRAPPANEL" );
...
/*	else if ( Q_strcmp(PANEL_OVERVIEW, szPanelName) == 0 )
	...
	*/
	...
	/*else if ( Q_strcmp(PANEL_CAMERAMENU, szPanelName) == 0 )
	{
		newpanel = new COverlordCameraMenu( this );
	}*/
	else if( Q_strcmp(PANEL_POWERUPPANEL, szPanelName) == 0)
	{
		newpanel = new COverlordPowerupPanel( this);
	}
	else if ( Q_strcmp(PANEL_CLASS, szPanelName) == 0 )
	{
		newpanel = new COverlordClassMenu( this );
	}
	else if ( Q_strcmp(PANEL_OVCLASS, szPanelName) == 0 )
	{
		newpanel = new COverlordOvClassMenu( this );
	}
	else if ( Q_strcmp(PANEL_SELECTION, szPanelName) == 0 )
	{
		newpanel = new COverlordSelection( this );
	}
	else if ( Q_strcmp(PANEL_TRAPMENU, szPanelName) == 0 )
	{
		newpanel = new COverlordTrapMenu( this );
	}
	else if ( Q_strcmp(PANEL_TRAPSTATUS, szPanelName) == 0 )
	{
		newpanel = new COverlordTrapStatus( this );
	}
	else if ( Q_strcmp(PANEL_TRAPMANAGER, szPanelName) == 0 )
	{
		newpanel = new COverlordTrapManager( this );
	}
	else if ( Q_strcmp(PANEL_POPUP, szPanelName) == 0 )
	{
		newpanel = new COverlordPopup(this);
	}
	else if ( Q_strcmp(PANEL_PROGRESSBAR, szPanelName) == 0 )
	{
		newpanel = new COverlordProgressPanel(this);
	}
	else if ( Q_strcmp(PANEL_STATICTRAPPANEL, szPanelName) == 0 )
	{
		newpanel = new COverlordStaticTrapPanel(this);
	}
#endif
