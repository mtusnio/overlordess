...
public:
	...
	void SetMaterialOverlay(const char * material, OverlayType_t type = OVERLAY, bool bOn = true);
private:
	...
	// Material overlay stuff
	OverlayType_t m_OverlayType;
	bool m_bOverlayOn;
	char m_OverlayMaterial[256];
};
