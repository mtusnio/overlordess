...
public:
	...
	void						DrawProgressBarWithOutline(int xpos, int ypos, int outlinedist,
	...
	void						DrawIconProgressBar( int x, int y, CHudTexture *icon, CHudTexture *icon2, float percentage, Color& clr, int type, int wide = 1, int high = 1);
