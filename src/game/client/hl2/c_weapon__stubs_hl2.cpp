...
/*
STUB_WEAPON_CLASS( weapon_psychokinesis, WeaponPsychokinesis, C_BasePsionic);
STUB_WEAPON_CLASS( weapon_overshield, WeaponShield, C_BasePsionic);
STUB_WEAPON_CLASS( weapon_haste, WeaponHaste, C_BaseHL2MPBludgeonWeapon);
STUB_WEAPON_CLASS( weapon_hackdevice, WeaponHackdevice, C_OverlordClassWeap);
STUB_WEAPON_CLASS( weapon_medkit, WeaponMedkit, C_OverlordMedkit);
STUB_WEAPON_CLASS( weapon_invisibility, WeaponInvisibility, C_OverlordClassWeap);
STUB_WEAPON_CLASS( weapon_knife, WeapoKnife, C_OverlordClassWeap);
STUB_WEAPON_CLASS( weapon_psion, WeaponPsion, C_OverlordClassWeap);
*/
#ifdef HL2_EPISODIC
