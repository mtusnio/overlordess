...
#define HOOK_SELECTION_COMMAND(command, function) CON_COMMAND_F(##command##, "", FCVAR_HIDDEN) \
	{	\
	CBaseHudWeaponSelection * instance =  CBaseHudWeaponSelection::GetInstance(); \
	if(instance) \
	instance->UserCmd_##function##(); \
	} 
...
/*HOOK_SELECTION_COMMAND( slot1, Slot1 );
HOOK_SELECTION_COMMAND( slot2, Slot2 );
HOOK_SELECTION_COMMAND( slot3, Slot3 );
HOOK_SELECTION_COMMAND( slot4, Slot4 );
HOOK_SELECTION_COMMAND( slot5, Slot5 );
HOOK_SELECTION_COMMAND( slot6, Slot6 );
HOOK_SELECTION_COMMAND( slot7, Slot7 );
HOOK_SELECTION_COMMAND( slot8, Slot8 );
HOOK_SELECTION_COMMAND( slot9, Slot9 );
HOOK_SELECTION_COMMAND( slot0, Slot0 );
HOOK_SELECTION_COMMAND( slot10, Slot10 );
HOOK_SELECTION_COMMAND( cancelselect, Close );
HOOK_SELECTION_COMMAND( invnext, NextWeapon );
HOOK_SELECTION_COMMAND( invprev, PrevWeapon );
HOOK_SELECTION_COMMAND( lastinv, LastWeapon );*/
...
CBaseHudWeaponSelection *CBaseHudWeaponSelection::GetInstance()
{
	...
	return static_cast<CBaseHudWeaponSelection*>(gHUD.FindElement("CHudWeaponSelection"));*/
}
...
{	
	...
	SetHiddenBits( HIDEHUD_WEAPONSELECTION | HIDEHUD_NEEDSUIT | HIDEHUD_PLAYERDEAD | HIDEHUD_INVEHICLE | HIDEHUD_CAMERA );
}
